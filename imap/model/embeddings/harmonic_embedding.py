...
import torch
from imap.model.embeddings.base_embedding import BaseEmbedding


class HarmonicEmbedding(BaseEmbedding):
    def __init__(
        self,
        ...
        """
        super().__init__((n_harmonic_functions * 2 + int(append_input)) * 3)
